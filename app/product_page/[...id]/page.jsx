  ...
  const Terms = () => (
    <div className={isChecked ? "showMe" : ""} id="termsWrap" ref={termRef}>
      ...
      >
        ...
        <p className="my-4">
          All Roweam™ New Vintage items are made to order and custom, therefore
          they are ineligible for returns or exchanges. Please note that all
          lead times are estimated and subject to change. If a multiple item
          custom order is placed, items will ship when all custom pieces are
          complete. Dye lots and color variations on fabric and finishes are
          subject to a 10% variation, as our stains are hand applied and fabrics
          vary per bolt. If you are interested in seeing the finishes in person,
          please email trade@roweam.com for samples. Buyer is responsible for
          properly measuring your point of entry and intended furniture location
          to ensure a true fit. If an order must be canceled immediately after
          placement, we allow for a 24 hour grace period to contact us at
          hello@roweam.com to cancel your order. Our teams personally inspect
          all items as they prepare to ship to ensure the finest quality. It is
          the responsibility of the buyer to inspect their custom new vintage
          pieces upon receipt to notice of any damage incurred during transit.
          Roweam™ is not responsible for any damages incurred after items leave
          our manufacturer. Please notate any signs of transit damage and
          contact us immediately at hello@roweam.com so that we may file claims
          with the responsible carrier. Roweam™ will honor any damages
          determined to be a manufacturing issue. If any manufacturing damages
          are found, please contact us immediately.
        </p>

        <a
          href="/"
          className="block relative leading-[45px] px-[35px] text-center no-underline text-milk bg-lightBrown mt-[10px] cursor-pointer whitespace-nowrap w-max"
          onClick={(e) => {
            e.preventDefault();
            termRef.current.classList.remove("showMe");
          }}
        >
          Accept
        </a>
          ...
          <div className="py-6 px-0 md:p-20 relative md:sticky md:left-0 top-0 w-full product-info">
            ...
            <div className="grid" style={{ rowGap: "16px" }}>
              ...
              <div
                ...
                style={{ gridTemplateColumns: "110px auto" }}
              >
                <div className="border border-darkGray px-[10px] h-[45px] w-full">
                  <div className="inline-flex items-center justify-center">
                    <button
                      className="flex items-center h-[45px] justify-center w-auto"
                ...
                <div>
                  <form onSubmit={(e) => e.preventDefault()}>
                    <div className="absolute top-0 left-0 w-full">
                      ...
                      <div className="absolute w-full bottom-[-260px] text-[13px]">
                        <div>
                          <p className="w-full block">
                            ...
                            <svg
                              ...
                              viewBox="0 0 341 81"
                              fill="none"
                              className="h-[14px] w-[56px] mt-[1px] overflow-hidden inline-flex"
                            >
                              <path
                                fillRule="evenodd"
                                clipRule="evenodd"
                    ...
                    <div className="grid gap-[10px]">
                      ...
                      >
                        <span
                          ...
                          style={{
                            letterSpacing: "1.3px",
                            visibility: addingToCart ? "hidden" : "visible",
                          }}
                        >
                          Add to cart
                        </span>
                        <span
                          className="loader-button absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 block"
                          style={{
                            visibility: addingToCart ? "visible" : "hidden",
              ...
              <div className="bg-milk p-5 text-[13px] text-left">
                Kindly allow 2-3 weeks lead time for quality assurance,
                packaging and shipping. Thank you.
              </div>
            </div>
          </div>
        </div>
