...
export default function TheAnniversaryCollection() {
  ...
  return (
    <section className="mt-[100px]">
      <div className="flex flex-wrap mt-7 relative max-w-[1600px]">
        <div
          className="w-full order-2 overflow-hidden"
        ...
        <div className="mx-6">
          <h1 className="h2 text-2xl">The Anniversary Collection</h1>
        </div>
      </div>
      ...
      <div>
        <section>
          <div className="my-10">
            <div className="max-w-[1600px] px-6 md:px-10">
              ...
              >
                <div className="order-2 pt-[60px] relative top-0 w-full max-w-full">
                  <div
                    className="grid items-center"
                    style={customStyles.article_img_wrapper}
                  >
                    <a href="/" className="max-w-full block">
                      <img
                    ...
                    <div>
                      <div className="mt-5 text-lightBrown text-xs uppercase">
                        featured
                      </div>
                      <a
                        href="/"
            ...
            <div className="px-6 md:px-10">
              <div className="relative block">
                <div
                  ...
                  style={{ gridTemplateColumns: "100%", gap: "32px 12px" }}
                >
                  <div>
                    <a
                      href="/"
        ...
        <section className="my-7">
          <div className="px-6 md:px-10 max-w-[1600px]">
            <header className="max-w-full mb-[30px]">
              <div>
