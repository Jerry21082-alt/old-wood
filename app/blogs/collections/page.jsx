        ...
        <div className="w-full max-w-[1600px] px-6 md:px-10">
          <div className="flex flex-wrap justify-start gap-6">
            <div className="w-full">
              ...
              <div>
                <h3 className="mt-[12px] mb-4 text-[18px] block pb-[5px] w-full h2">
            ...
            <div style={{ width: "calc(50% - 12px)" }}>
              ...
              <div>
                ...
                <h3 className="mt-[12px] mb-4 text-[18px] block w-full pb-[5px] h2">
            ...
            <div className="w-full">
              ...
              <div>
                <h3 className="mt-[12px] text-[18px] block pb-[5px] w-full h2">
                  The Pavillion Collection
                </h3>

                <div className="text-lightBrown text-xs h3 mb-4">
            ...
            <div className="w-full">
              ...
              <div>
                ...
                <div className="text-lightBrown text-xs h3">
