    ...
    <section className="mt-7">
      <div className="w-full">
        <div className="flex flex-wrap">
          <div className="order-2 overflow-hidden bg-milk">
            <img
          ...
          <div className="order-3 w-full px-6 overflow-hidden">
            <ul className="flex border-b mt-[60px] border-listBorder overflow-visible w-[200%]">
              <li className="pr-[30px] whitespace-nowrap">
                <h5>
                  <a
                    href="#"
                    className="text-xs relative pr-[10px] text-darkGray"
                  >
                    About
                  </a>
                </h5>
      ...
      <div className="m-7">
        <div>
          <div className="pb-6 pt-8 relative">
            <div className="w-full max-w-[1600px]">
              <div className="flex flex-wrap relative">
                <div className="order-2 mt-[30px] w-full relative">
                  <img
          ...
          <div className="-mb-7 pt-7 pb-7">
            <div className="w-full max-w-[600px] px-6">
              <div className="flex flex-wrap relative overflow-hidden">
                <div className="mt-[-50%] pl-[30%] order-2 w-full relative">
                  <img
